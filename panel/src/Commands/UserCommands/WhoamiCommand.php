...
class WhoamiCommand extends UserCommand
{
    ...
    protected $description = 'Muestra tu nombre de usuario, password y la dirección del panel de control para tus grabaciones';
    ...
    public function execute()
    {
        ...
        $caption = 'Tu nombre de usuario: ' . $message->getFrom()->getFirstName() ."\n";
        $caption .= 'Tu password: ' . $user_id . "\n";
        $caption .= 'Gestiona tus grabaciones: http://bots.ikasten.io '. "\n";
